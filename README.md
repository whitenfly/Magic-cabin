...
**当前阶段：`J4` 系统模块化 🟡 开发中**（`J4.1` 段切片基础设施 + `ui` 搬迁、`J4.2` `audio` 已完成 —— 见 [`docs/实施结果/J4.1-实施结果.md`](./docs/实施结果/J4.1-实施结果.md)）
**当前稳定版：`v0.3.0`**（tag `v0.3.0`，开发主线在 `dev` 分支；本阶段任务快照 `v0.4.0-dev.1`–`dev.2` —— 见 [`docs/VERSIONING.md`](./docs/VERSIONING.md)）
