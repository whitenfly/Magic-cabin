...
**当前阶段：`J3` 物件模块化 🟡 基础设施完成 + 35/67 件搬迁；`J3.1` 交互通路回归修复 ✅**（版本 `0.3.0`，见 [`docs/实施结果/J3-实施结果.md`](./docs/实施结果/J3-实施结果.md)、[`J3.1-实施结果.md`](./docs/实施结果/J3.1-实施结果.md)）
**当前稳定版：`v0.2.5`**（tag `v0.2.5`，开发主线在 `dev` 分支；`J3` 的开发版快照是 `v0.3.0-dev.2` —— 见 [`docs/VERSIONING.md`](./docs/VERSIONING.md)）
